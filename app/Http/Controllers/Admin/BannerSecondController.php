...
class BannerSecondController extends Controller
{
    ...
    public function index(){
        ...
        return view('backend.second_banner.index',compact('category_list_six','category_list_five','category_list_four','category_list','category_list_one','category_list_two','category_list_three'));
    }
