...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Purchase Return Product Information</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    {{-- <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li> --}}
                    <li class="breadcrumb-item active">Product All Purchase Return Product</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <h4 class="card-title">Product Purchase Return Listing</h4>
        <p class="card-title-desc">You can <code>Show, Hide & Edit</code> All Purchase Return Product</p>
    </div>
</div>
<!-- search bar --->
<div class="row">
...
<div class="row mt-2">
    ...
    <div class="col-sm-6">
        <div class="text-sm-end">
        <a href="{{ route('purchase_return_create') }}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2">
        <i class="mdi mdi-plus me-1"></i> Add New Purchase Return Product</a>
        </div>
...
@endforeach
                ...
                @include('backend.purchase_return.normal_pagination')
            </div>
        </div>
    </div>
</div>
