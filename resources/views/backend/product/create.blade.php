...
<div class="d-flex justify-content-start" style="overflow-y:auto;" id="mainchil">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="manufacture" type="text" class="form-control" id=""
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="manufacture_part_number" class="form-control" id=""
                                           placeholder="Enter Part Number">
                                </div>

                                <div class="mb-3">
                                    <label for="" class="form-label">SEO Keywords</label>
                                    <input type="text" name="seo_keyword" class="form-control" id=""
                                           placeholder="Enter Part Number">
                                </div>

                                <div class="mb-3">
                                    <label for="" class="form-label">Catalog Number</label>
                                    <input type="text" name="catalog_number" class="form-control" id=""
