                ...
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-9">
                                {{-- <input class="form-control" type="text" name="order_by_price_f" value="" id="total_grand_price_f" readonly> --}}

                                <select class="form-select" name="order_by" id="order_by">
                                    <option>Select</option>
                                    @foreach($order_by_list as $all_order_by_list)
                                    <option value="{{ $all_order_by_list->company_name }}" {{ $order_by_list_first->per_name == $all_order_by_list->company_name ? 'selected':'' }}>{{ $all_order_by_list->company_name }}</option>
        @endforeach
                                </select>
                            </div>
                        </div>
