...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">First Banner List</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">

                    <li class="breadcrumb-item active">First Banner</li>
                </ol>
            </div>
...
<h6 class="card-title text-center">First</h6>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('first_banner_store') }}" enctype="multipart/form-data">
                    @csrf
...
<input type="text" class="form-control" name="t_three" />
                ...
                @else
                <form method="post" action="{{ route('first_banner_update') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">Title One</label>
<input type="text" class="form-control" name="t_one" value="{{ $all_category_list_one->first_title }}" />

                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Title Two</label>
<input type="text" class="form-control" name="t_two" value="{{ $all_category_list_one->second_title }}" />

                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Title Three</label>
<input type="text" class="form-control" name="t_three" value="{{ $all_category_list_one->third_title }}" />
