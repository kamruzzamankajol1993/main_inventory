...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Request Product Information</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    {{-- <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li> --}}
                    <li class="breadcrumb-item active">Product All Request Product</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <h4 class="card-title">Product Request Product Listing</h4>
        <p class="card-title-desc">You can <code>Show, Hide & Edit</code> All Request Product</p>
    </div>
</div>
<!-- search bar --->
<div class="row">
...
<div class="row mt-2">
    ...
    <div class="col-sm-6">
        <div class="text-sm-end">
        <a href="{{ route('request_product_create') }}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2">
        <i class="mdi mdi-plus me-1"></i> Add New Request Product</a>
        </div>
 ...
 <th>Total Quantity</th>
                <th>Request date</th>
                        ...
                        <tbody>
                            ...
                            @foreach($request_product_list as $key=>$all_attribute)
                        <tr>
                            <td>
                                <div class="form-check font-size-16">
