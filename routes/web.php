...
Route::group(['prefix' => 'admin'], function () {
    ...
    //end about us
    Route::get('get_vendor_for_request_and_purchase', [RequestproductController::class, 'get_vendor_for_request_and_purchase'])->name('get_vendor_for_request_and_purchase');
    //request product
    Route::get('request_product/create', [RequestproductController::class, 'create'])->name('request_product_create');
    Route::get('request_product', [RequestproductController::class, 'index'])->name('request_product');
    Route::post('request_product_store', [RequestproductController::class, 'store'])->name('request_product_store');
    Route::post('request_product_update', [RequestproductController::class, 'update'])->name('request_product_update');
    Route::post('request_product_delete/{id}', [RequestproductController::class, 'delete'])->name('request_product_delete');
    Route::get('request_product_view/{id}', [RequestproductController::class, 'view'])->name('request_product_view');
    ...
    Route::get('request_product_pagination_start_search_ajax', [RequestproductController::class, 'request_product_pagination_start_search_ajax'])->name('request_product_pagination_start_search_ajax');
    //request product

    ///vendor
    Route::get('vendor', [VendorController::class, 'index'])->name('vendor');
    Route::post('vendor_store', [VendorController::class, 'store'])->name('vendor_store');
    Route::post('vendor_update', [VendorController::class, 'update'])->name('vendor_update');
    Route::post('vendor_delete/{id}', [VendorController::class, 'delete'])->name('vendor_delete');
    Route::get('vendor_view/{id}', [VendorController::class, 'view'])->name('vendor_view');
    Route::get('vendor_pagination_start_delete', [VendorController::class, 'vendor_pagination_start_delete'])->name('vendor_pagination_start_delete');
    Route::get('vendor_pagination_start', [VendorController::class, 'vendor_pagination_start'])->name('vendor_pagination_start');
    Route::get('vendor_pagination_start_search', [VendorController::class, 'vendor_pagination_start_search'])->name('vendor_pagination_start_search');
    Route::get('vendor_pagination_start_search_ajax', [VendorController::class, 'vendor_pagination_start_search_ajax'])->name('vendor_pagination_start_search_ajax');
    ...
    Route::post('store_update', [StoreController::class, 'update'])->name('store_update');
    Route::post('store_delete/{id}', [StoreController::class, 'delete'])->name('store_delete');
    Route::get('store_pagination_start_delete', [StoreController::class, 'store_pagination_start_delete'])->name('store_pagination_start_delete');
    Route::get('store_pagination_start', [StoreController::class, 'store_pagination_start'])->name('store_pagination_start');
    Route::get('store_pagination_start_search', [StoreController::class, 'store_pagination_start_search'])->name('store_pagination_start_search');
    Route::get('store_pagination_start_search_ajax', [StoreController::class, 'store_pagination_start_search_ajax'])->name('store_pagination_start_search_ajax');
    //store


    ///warehouse

    Route::get('ware_house', [WarehouseController::class, 'index'])->name('ware_house');
    Route::post('ware_house_store', [WarehouseController::class, 'store'])->name('ware_house_store');
    Route::post('ware_house_update', [WarehouseController::class, 'update'])->name('ware_house_update');
    Route::post('ware_house_delete/{id}', [WarehouseController::class, 'delete'])->name('ware_house_delete');
    Route::get('ware_house_pagination_start_delete', [WarehouseController::class, 'ware_house_pagination_start_delete'])->name('ware_house_pagination_start_delete');
    Route::get('ware_house_pagination_start', [WarehouseController::class, 'ware_house_pagination_start'])->name('ware_house_pagination_start');
    Route::get('ware_house_pagination_start_search', [WarehouseController::class, 'ware_house_pagination_start_search'])->name('ware_house_pagination_start_search');
    Route::get('ware_house_pagination_start_search_ajax', [WarehouseController::class, 'ware_house_pagination_start_search_ajax'])->name('ware_house_pagination_start_search_ajax');
    ///warehouse
    ...
    Route::get('purchase_pagination_start_search_ajax', [PurchaseController::class, 'purchase_pagination_start_search_ajax'])->name('purchase_pagination_start_search_ajax');
    ...
    Route::get('purchase_return_pagination_start_search_ajax', [PurchaseReturnController::class, 'purchase_return_pagination_start_search_ajax'])->name('purchase_return_pagination_start_search_ajax');
    ///purchase return
    ...
    Route::get('order_by_pagination_start_delete', [OrderByController::class, 'order_by_pagination_start_delete'])->name('purchase_pagination_start_delete');
    Route::get('order_by_pagination_start', [OrderByController::class, 'order_by_pagination_start'])->name('purchase_pagination_start');
    Route::get('order_by_pagination_start_search', [OrderByController::class, 'order_by_pagination_start_search'])->name('purchase_pagination_start_search');
    Route::get('order_by_pagination_start_search_ajax', [OrderByController::class, 'order_by_pagination_start_search_ajax'])->name('purchase_pagination_start_search_ajax');
